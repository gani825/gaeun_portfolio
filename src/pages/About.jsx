                ...
                <div className="about-info-block">
                    ...
                    <div className="about-Introduce">
                        ...
                        <p>
                            ...
                            실력을 키웠습니다.
                            PlanFit 프로젝트에서는 <strong>React와 Figma를 활용해 UI/UX 설계를 경험</strong>했고,
                            HandTrip에서는 <strong>백엔드 협업과 API 연동, GitHub 실시간 코드 병합을 경험</strong>했습니다.
                            또한, <strong>React Hooks로 상태 관리와 성능 최적화를 익히며, 유지보수성과 재사용성을 높이는
                            개발 역량</strong>을 키웠습니다.
                            새 환경에 빠르게 적응하고, <strong>팀워크와 사용자 중심 개발을 중시하는 프론트엔드 개발자로 성장</strong>하겠습니다.
                        </p>
                    </div>
                    ...
                    <div className="about-study">
                        ...
                        <p>
                            ...
                            피그마를 활용하여 컴포넌트, 베리언트, 디자인, 와이어프레임 등을 학습하였으며, 이후 HTML 을 통해 웹
                            구조를 이해하고 CSS 를 활용한 스타일 적용, Flexbox·Grid 를 이용한 레이아웃 구성, 미디어 쿼리를 통한
                            반응형 디자인 구현 방법을 배웠습니다. jQuery 를 활용하여 플러그인 없이 애니메이션을 적용하는
                            방법을 익힌 후, JavaScript 를 통해 동적 UI 요소를 개발하고 웹 페이지에 상호작용 기능을 추가하는
                            방법을 학습하였습니다. 마지막으로 React 의 JSX 를 활용하여 선언적 UI 개발을 익히고, 팀 프로젝트를
                            통해 React 를 활용한 피트니스 캘린더 웹사이트를 제작하였습니다.
                        </p>
                    </div>
                </div>
            </div>
